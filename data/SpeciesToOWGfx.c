...
const u16 UNUSED sSpeciesToOWGfx[] =
{
    ...
    [SPECIES_SPEKTRE            ] = 1309,
    [SPECIES_NITEMUR            ] = 1310,
    [SPECIES_LICKIDRULE         ] = 1311,
    [SPECIES_AFROSTITE          ] = 1312,
    [SPECIES_LEDIDER            ] = 1313,
    [SPECIES_SPIDEATH           ] = 1314,
    [SPECIES_FALREST            ] = 1315,
    [SPECIES_GIGATOBULL         ] = 1316,
    [SPECIES_LIQWILDATE         ] = 1317,
    [SPECIES_CURESOLA           ] = 1318,
    [SPECIES_TAKORONEL          ] = 1319,
    [SPECIES_BIRNIGNANT         ] = 1320,
    [SPECIES_GOBLEYE            ] = 1321,
    [SPECIES_CACTOLERO          ] = 1322,
    [SPECIES_DRIFELIN           ] = 1323,
    [SPECIES_ARMAGESNOW         ] = 1324,
    [SPECIES_NURSAUND           ] = 1325,
    [SPECIES_DISGUMSTER         ] = 1326,
    [SPECIES_YOOEFOH            ] = 1327,
    [SPECIES_KOMALARGY          ] = 1328,
};
